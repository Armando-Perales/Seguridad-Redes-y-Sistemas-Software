...
## Solución
```bash
┌──(armando㉿kali)-[~/picoCTF/crypto/lacifrade]
...
└─$ 
```
- Entramos a la siguiente pagina, donde le colocamos el texto encriptado y con esto obtenemos la llave y al mismo tiempo el texto desencriptado.
