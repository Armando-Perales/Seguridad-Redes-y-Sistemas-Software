## Objetivo
Can you figure out how this program works to get the flag? Connect to the program with netcat: `$ nc saturn.picoctf.net 52076` The program's source code can be downloaded [here](https://artifacts.picoctf.net/c/525/picker-III.py).
## Solución

```bash
┌──(armando㉿kali)-[~/picoCTF/reversing/picker3]
└─$ ls
picker-III.py
...
```
- Le enviamos un `help` para que nos muestre su menú y aquí seleccionaremos la opción 3 el cual nos permitirá cambiar la funcionalidad con respecto a una variable que en este caso cambiamos a la variable `getRandomNumber` por la de `win` para que al momento de seleccionar la opción 4 ejecute la función `win`.
```bash
┌──(armando㉿kali)-[~/picoCTF/reversing/picker3]
└─$ nc saturn.picoctf.net 52076
==> help
...
==> 
```
- A partir de aquí hay 2 formas de obtener la bandera correctamente:
### Opción 1
- Redactamos en Python un pequeño ciclo que imprima la bandera.
```bash
┌──(armando㉿kali)-[~/picoCTF/reversing/picker3]
└─$ python3
Python 3.12.6 (main, Sep  7 2024, 14:20:15) [GCC 14.2.0] on linux
Type "help", "copyright", "credits" or "license" for more information.
>>> cadena = "0x70 0x69 0x63 0x6f 0x43 0x54 0x46 0x7b 0x37 0x68 0x31 0x35 0x5f 0x31 0x35 0x5f 0x77 0x68 0x34 0x37 0x5f 0x77 0x33 0x5f 0x67 0x33 0x37 0x5f 0x77 0x31 0x37 0x68 0x5f 0x75 0x35 0x33 0x72 0x35 0x5f 0x31 0x6e 0x5f 0x63 0x68 0x34 0x72 0x67 0x33 0x5f 0x61 0x31 0x38 0x36 0x66 0x39 0x61 0x63 0x7d"
>>> cadena
'0x70 0x69 0x63 0x6f 0x43 0x54 0x46 0x7b 0x37 0x68 0x31 0x35 0x5f 0x31 0x35 0x5f 0x77 0x68 0x34 0x37 0x5f 0x77 0x33 0x5f 0x67 0x33 0x37 0x5f 0x77 0x31 0x37 0x68 0x5f 0x75 0x35 0x33 0x72 0x35 0x5f 0x31 0x6e 0x5f 0x63 0x68 0x34 0x72 0x67 0x33 0x5f 0x61 0x31 0x38 0x36 0x66 0x39 0x61 0x63 0x7d'
...
```
### Opción 2
- Le enviamos a `Cyber Chef` la bandera dada y le aplicamos el filtro de `From Hex`.
```bash
0x70 0x69 0x63 0x6f 0x43 0x54 0x46 0x7b 0x37 0x68 0x31 0x35 0x5f 0x31 0x35 0x5f 0x77 0x68 0x34 0x37 0x5f 0x77 0x33 0x5f 0x67 0x33 0x37 0x5f 0x77 0x31 0x37 0x68 0x5f 0x75 0x35 0x33 0x72 0x35 0x5f 0x31 0x6e 0x5f 0x63 0x68 0x34 0x72 0x67 0x33 0x5f 0x61 0x31 0x38 0x36 0x66 0x39 0x61 0x63 0x7d 
